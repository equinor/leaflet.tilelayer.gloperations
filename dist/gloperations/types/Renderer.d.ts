...
export default class Renderer {
    ...
    flipReadPixelsFloat(width: number, height: number, pixels: Float32Array): Float32Array;
    ...
    renderTilesWithDiff(tilesA: TileDatum[], tilesB: TileDatum[], colorScale: Color[], sentinelValues: SentinelValue[], onFrameRendered: (canvasCoordinates: Array<Pair<number>>) => void): Uint8Array[];
    renderTilesWithMultiAnalyze1(tilesA: TileDatum[], colorScale: Color[], sentinelValues: SentinelValue[], filterLowA: number, filterHighA: number, multiplierA: number, onFrameRendered: (canvasCoordinates: Array<Pair<number>>) => void): Uint8Array[];
    renderTilesWithMultiAnalyze2(tilesA: TileDatum[], tilesB: TileDatum[], colorScale: Color[], sentinelValues: SentinelValue[], filterLowA: number, filterHighA: number, filterLowB: number, filterHighB: number, multiplierA: number, multiplierB: number, onFrameRendered: (canvasCoordinates: Array<Pair<number>>) => void): Uint8Array[];
