...
function createHsAdvSmoothCommand(regl, commonConfig) {
    return regl(__assign(__assign({}, commonConfig), { vert: vertSingleNotTransformed, frag: fragHsAdvSmooth, uniforms: __assign(__assign({}, commonConfig.uniforms), { tInput: regl.prop("tInput"), textureSize: regl.prop("textureSize"), kernelSize: regl.prop("kernelSize") }), attributes: {
...
var Renderer = (function () {
    function Renderer(gloperations, tileSize, nodataValue, scaleInput, sentinelInput, colorscaleMaxLength, sentinelMaxLength) {
        ...
        var normalTextureDimension = 1024;
        var regl = REGL({
            canvas: canvas,
        ...
        Object.assign(this, {
            ...
            HsAdvSmooth: createHsAdvSmoothCommand(regl, commonDrawConfig),
        });
    }
    Renderer.prototype.findMaxTextureDimension = function () {
        var maxTextureDimension = 1024;
    ...
    Renderer.prototype.renderTilesHsAdvanced = function (tiles, _hillshadeOptions, url, zoom, pixelScale) {
        return __awaiter(this, void 0, void 0, function () {
            var _a, regl, textureManager, tileSize, nodataValue, _b, canvasWidth, canvasHeight, canvasCoordinates, tilesWithCanvasCoordinates, canvasSize, chunks, nodataTile, hsValueScale, _i, chunks_3, chunk_4, _c, chunk_3, tile, coords, pixelData, canvasCoords, textureCoords, baselayerTexCoords, basePixelData, textureBounds, fboFloats, fboSmoothed, fboNormals, fboSoftShadowPP, fboAmbientShadowPP, i, i;
            return __generator(this, function (_d) {
                switch (_d.label) {
                    case 0:
                        _a = this, regl = _a.regl, textureManager = _a.textureManager, tileSize = _a.tileSize, nodataValue = _a.nodataValue;
                        _b = this.computeRequiredCanvasDimensions(tiles.length), canvasWidth = _b[0], canvasHeight = _b[1];
                        this.setCanvasSize(canvasWidth, canvasHeight);
                        ...
                        textureManager.clearTiles();
                        regl.clear({ color: CLEAR_COLOR });
                        chunks = chunk(tilesWithCanvasCoordinates, textureManager.tileCapacity);
                        nodataTile = createNoDataTile(nodataValue, tileSize);
                        hsValueScale = 1.0;
                        if (typeof _hillshadeOptions.hsAdvValueScale === "number") {
                            hsValueScale = _hillshadeOptions.hsAdvValueScale;
                        }
                        ...
                        _d.label = 1;
                    case 1:
                        if (!(_i < chunks_3.length)) return [3, 9];
                        chunk_4 = chunks_3[_i];
                        _c = 0, chunk_3 = chunk_4;
                        _d.label = 2;
                    case 2:
                        if (!(_c < chunk_3.length)) return [3, 8];
                        tile = chunk_3[_c];
                    ...
                    case 4:
                        textureCoords = _d.sent();
                        baselayerTexCoords = [];
                        if (!_hillshadeOptions.hsAdvBaselayerUrl) return [3, 6];
                        return [4, this.gloperations._fetchTileData(coords, _hillshadeOptions.hsAdvBaselayerUrl, "image")];
                    case 5:
                        basePixelData = _d.sent();
                        textureBounds = this.textureManagerHillshade.addTile(coords, basePixelData);
                    ...
                    case 8:
                        _i++;
                        return [3, 1];
                    case 9: return [2, canvasCoordinates];
                }
            });
        });
    };
    ...
    Renderer.prototype.renderTilesWithTransition = function (oldTiles, newTiles, transitionDurationMs, onFrameRendered) {
        return __awaiter(this, void 0, void 0, function () {
            var _a, regl, textureManager, tileSize, normalTextureDimension, canvasSize, canvasWidth, canvasHeight, canvasCoordinates, tilesWithCanvasCoordinates, newTextureManager, transitionStart, renderFrame, animationHandle;
            var _this = this;
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
                        _a = this, regl = _a.regl, textureManager = _a.textureManager, tileSize = _a.tileSize, normalTextureDimension = _a.normalTextureDimension;
                        ...
                        newTextureManager = new TextureManager(regl, tileSize, normalTextureDimension, false);
    ...
    Renderer.prototype.generateSunDirections = function (iterations, sunRadiusMultiplier) {
        ...
        for (var i = 0; i < iterations; i++) {
            var direction = vec3.normalize(vec3.create(), vec3.add(vec3.create(), vec3.scale(vec3.create(), vec3.normalize(vec3.create(), [1, 1, 1]), EARTH_SUN_DISTANCE), vec3.random(vec3.create(), SUN_RADIUS * sunRadiusMultiplier)));
    ...
    Renderer.prototype.generateAmbientDirections = function (iterations) {
        ...
        for (var i = 0; i < iterations; i++) {
            var direction = vec3.random(vec3.create(), Math.random());
...
var littleEndian$2 = machineIsLittleEndian();
var defaultOptions = {
    tileFormat: 'float32',
    colorScale: [],
    sentinelValues: [],
...
var GLOperations = (function (_super) {
    ...
    function GLOperations(options) {
        ...
        _this.on("load", function (_) {
            return setTimeout(function () {
                ...
                if (_this.options.hillshadeType === 'advanced' &&
                    _this._renderer.textureManager.available.length < _this._renderer.textureManager.contents.size) {
                    _this._renderer.textureManager.clearTiles();
                }
            }, 300);
        });
        setTimeout(function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 2:
                        ...
                        return [3, 6];
                    case 3:
                        if (!(this.options._hillshadeOptions.hillshadeType === 'advanced')) return [3, 5];
                        this._map.fire('calcHsAdvanced', { status: true });
                        return [4, this._renderer.renderTilesHsAdvanced(tilesData, this.options._hillshadeOptions, this.options.url, this._getZoomForUrl(), this._getPixelScale())];
                    case 4:
                        canvasCoordinates = _a.sent();
    ...
    GLOperations.prototype.setHillshadeOptions = function () {
    ...
    GLOperations.prototype._getPixelValue = function (pixelData, byteIndex) {
        ...
        var pixelValue = tileDataView.getFloat32(byteIndex, littleEndian$2);
