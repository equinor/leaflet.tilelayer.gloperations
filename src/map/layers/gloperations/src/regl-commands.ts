...
/**
 * The resulting Regl DrawCommand is used to calculate the normals of the float values.
...
export function createHsAdvCalcNormals(
  ...
  return regl<HsAdvCalcNormals.Uniforms, HsAdvCalcNormals.Attributes, HsAdvCalcNormals.Props>({
    ...
    uniforms: {
      ...commonConfig.uniforms as DrawCommon.Uniforms,
      tElevation: regl.prop<HsAdvCalcNormals.Props, 'texture'>("texture"),
      pixelScale: regl.prop<HsAdvCalcNormals.Props, 'pixelScale'>("pixelScale"),
      resolution: regl.prop<HsAdvCalcNormals.Props, 'resolution'>("resolution"),
...
export function createHsAdvDirectLightning(
  ...
  return regl<HsAdvDirectLightning.Uniforms, HsAdvDirectLightning.Attributes, HsAdvDirectLightning.Props>({
    ...
    uniforms: {
      ...commonConfig.uniforms as DrawCommon.Uniforms,
      tNormal: regl.prop<HsAdvDirectLightning.Props, 'texture'>("texture"),
      // pixelScale: regl.prop<HsAdvDirectLightning.Props, 'pixelScale'>("pixelScale"),
      resolution: regl.prop<HsAdvDirectLightning.Props, 'resolution'>("resolution"),
    ...
    // framebuffer: regl.prop<HsAdvDirectLightning.Props, 'fbo'>("fbo"),
  });
}